...
const EventRegistration = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        ...
        setTimeout(() => setFetchingUser(false), 800);
      }
    };
    fetchUserData();
  }, [navigate, location]);
  ...
  return (
    /* Changed background to transparent to reveal the global grid */
    <div className="min-h-screen bg-transparent text-gray-200 py-12 px-4 font-sans relative">
      {/* Grid layer (if not already defined in App.js) */}
        ...
        <>
          ...
          <div className="max-w-xl mt-10 mx-auto space-y-8 transition-opacity duration-500 opacity-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Identity Card - Added backdrop-blur for grid compatibility */}
              <div className="bg-[#111]/80 backdrop-blur-md border border-[#222] p-5 rounded-xl">
              ...
              {/* Logistics Card - Added backdrop-blur */}
              <div className="bg-[#111]/80 backdrop-blur-md border border-[#222] p-5 rounded-xl space-y-5">
